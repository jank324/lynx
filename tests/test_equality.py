...
def test_drift_equal():
    ...
    drift_1 = Drift(name="drift_eq", length=jnp.array([0.1]))
    drift_2 = Drift(name="drift_eq", length=jnp.array([0.1]))
...
def test_drift_not_equal():
    ...
    drift_1 = Drift(name="drift_1", length=jnp.array([0.1]))
    drift_2 = Drift(name="drift_2", length=jnp.array([0.2]))
    assert drift_1 != drift_2
...
def test_quadrupole_equal():
    ...
    quadrupole_1 = Quadrupole(
        name="quadrupole_eq", length=jnp.array([0.1]), k1=jnp.array([0.2])
    )
...
def test_quadrupole_not_equal():
    ...
    quadrupole_1 = Quadrupole(
        name="quadrupole_1", length=jnp.array([0.1]), k1=jnp.array([0.2])
    )
    quadrupole_2 = Quadrupole(
        name="quadrupole_2", length=jnp.array([0.2]), k1=jnp.array([0.2])
    )
    assert quadrupole_1 != quadrupole_2
...
def test_segment_equal():
    ...
    segment_1 = Segment(
        elements=[
            Drift(name="d", length=jnp.array([0.1])),
            Quadrupole(name="q", length=jnp.array([0.1]), k1=jnp.array([0.2])),
        ],
        name="test_segment",
    )
    segment_2 = Segment(
...
def test_segment_not_equal():
    ...
    segment_2 = Segment(
        elements=[
            Quadrupole(name="q", length=jnp.array([0.2]), k1=jnp.array([0.2])),
            Drift(name="d", length=jnp.array([0.1])),
        ],
        name="test_segment",
    )
